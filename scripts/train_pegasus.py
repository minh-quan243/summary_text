# src/train_pegasus.py
import os
import yaml
import logging
import numpy as np
from evaluate import load  # ✅ dùng evaluate thay cho load_metric
...
logger = setup_logging("logs/train_pegasus.log")
set_seed(42)
...
def compute_metrics(eval_preds, tokenizer):
    """Tính ROUGE F1 trung bình giữa dự đoán và nhãn."""
    rouge = load("rouge")
...
def main(config_path):
    ...
    training_args = Seq2SeqTrainingArguments(
        output_dir=os.path.join(cfg["output_dir"], "pegasus"),
    ...
    logger.info("🏋️‍♂️ Training started...")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Train Pegasus model using YAML config.")
